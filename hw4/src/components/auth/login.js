				...
				<div className="panel-body">
					<form>
						<div className="form-group">
							...
							<input type="text" className="form-control" id="loginInputUsername" placeholder="Username" ref={(node) => {username = node}}/>
						</div>
						<div className="form-group">
							<label htmlFor="loginInputPassword">Password:</label>
							<input type="password" className="form-control" id="loginInputPassword" placeholder="Password" ref={(node) => {password = node}}/>
						</div>
